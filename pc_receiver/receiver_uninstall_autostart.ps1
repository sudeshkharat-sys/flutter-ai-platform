# Removes the Scheduled Task created by receiver_install_autostart.ps1. Does not
...
#
# Usage: powershell -ExecutionPolicy Bypass -File receiver_uninstall_autostart.ps1
